...
//        List<Project> list = projectService.getAllProject();
        ...
        request.getRequestDispatcher("/dist/forms/manage.jsp").forward(request, response);
    }
    ...
    public void getManageInfo(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/dist/forms/manage1.jsp").forward(request, response);
    }
