...
//        List<Project> list = projectService.getAllProject();
        ...
        request.getRequestDispatcher("/dist/forms/design.jsp").forward(request, response);
    }
    ...
    public void getDesignInfo(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/dist/forms/design1.jsp").forward(request, response);
    }
