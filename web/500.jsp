...
<head>
    ...
    <meta name="description" content="错误(code: 500)" />
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no" />
    <!--begin::Fonts-->
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700" />
    <!--end::Fonts-->
    <!--begin::Page Custom Styles(used by this page)-->
    <link href="<%=basePath%>dist/assets/css/pages/error/error-5.css" rel="stylesheet" type="text/css" />
...
<div class="d-flex flex-column flex-root">
    <!--begin::Error-->
    <div class="error error-5 d-flex flex-row-fluid bgi-size-cover bgi-position-center" style="background-image: url(<%=basePath%>dist/assets/media/error/bg5.jpg);">
        <!--begin::Content-->
        <div class="container d-flex flex-row-fluid flex-column justify-content-md-center p-12">
            <h1 class="error-title font-weight-boldest text-info mt-10 mt-md-0 mb-12">500</h1>
            <p class="font-weight-boldest display-4">服务器内部错误</p>
            <p class="font-size-h3">请联系管理员或稍候再试…</p>
