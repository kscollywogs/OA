...
<head>
    ...
    <meta name="description" content="员工界面，记录日常零星工作量" />
                ...
                <div class="d-flex flex-column-fluid">
                    ...
                    <div class="container col-sm-12 col-lg-7">
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <!--begin::Form-->
                            <form class="form" action="${pageContext.request.contextPath}/dailyWorkingServlet?method=addDailyWorking" method="post">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-3">
                                            <input type="number" class="form-control" placeholder="工日" id="monthDay" name="monthDay" required/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-1">
                                        ...
                                        <textarea type="text" class="form-control" name="remark" id="remark" rows="3"></textarea>
                                    </div>
                                </div>
