...
<head>
    ...
    <meta name="description" content="员工界面，记录调试/工程管理工作量" />
                ...
                <div class="d-flex flex-column-fluid">
                    ...
                    <div class="container">
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <!--begin::Form-->
                            <form class="form" action="${pageContext.request.contextPath}/debugWorkingServlet?method=addDebugWorking" method="post">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-3">
                                            <input type="number" class="form-control" id="workname" name="workname" />
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-3">
                                            <input type="text" class="form-control" placeholder="地点" id="site" name="site" autocomplete="off"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-3">
                                            <input type="number" class="form-control" placeholder="工日" id="manageday" name="manageday" autocomplete="off"/>
                                        </div>
                                        <label class="col-lg-2 col-form-label text-lg-right">工程调试</label>
                                        <div class="col-lg-3">
                                            <input type="number" class="form-control" placeholder="工日" id="debugday" name="debugday" autocomplete="off"/>
                                        </div>
                                    </div>
