...
<head>
    ...
    <meta name="description" content="员工界面，记录经营管理工作量" />
                ...
                <div class="d-flex flex-column-fluid">
                    ...
                    <div class="container">
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <!--begin::Form-->
                            <form class="form" action="${pageContext.request.contextPath}/manageWorkingServlet?method=addManageWorking" method="post">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-3">
                                            <input type="number" class="form-control" placeholder="询价/报价" id="xunjiabaojia" name="xunjiabaojia" autocomplete="off"/>
                                        </div>
                                        <label class="col-lg-2 col-form-label text-lg-right">标书制作</label>
                                        <div class="col-lg-3">
                                            <input type="number" class="form-control" placeholder="标书" id="tender" name="tender" autocomplete="off"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-3">
                                            <input type="number" class="form-control" placeholder="制作/签署等" id="sign" name="sign" autocomplete="off"/>
                                        </div>
                                        <label class="col-lg-2 col-form-label text-lg-right">投标工作</label>
                                        <div class="col-lg-3">
                                            <input type="number" class="form-control" placeholder="投标" id="toubiao" name="toubiao" autocomplete="off"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-3">
                                            <input type="number" class="form-control" placeholder="设备招标采购" id="equip" name="equip" autocomplete="off"/>
                                        </div>
                                        <label class="col-lg-2 col-form-label text-lg-right">设备检测</label>
                                        <div class="col-lg-3">
                                            <input type="number" class="form-control" placeholder="设备出厂检测" id="test" name="test" autocomplete="off"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-3">
                                            <input type="number" class="form-control" placeholder="催收欠款/尾款等" id="cuikuan" name="cuikuan" autocomplete="off"/>
                                        </div>
                                        <label class="col-lg-2 col-form-label text-lg-right">合同管理</label>
                                        <div class="col-lg-3">
                                            <input type="number" class="form-control" placeholder="合同管理" id="contract" name="contract" autocomplete="off"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-3">
                                            <input type="number" class="form-control" placeholder="其他相关业务" id="other" name="other" autocomplete="off"/>
                                        </div>
                                        <label class="col-lg-2 col-form-label text-lg-right">项目经理</label>
                                        <div class="col-lg-3">
                                            <input type="number" class="form-control" placeholder="工日" id="PMday" name="PMday" autocomplete="off"/>
