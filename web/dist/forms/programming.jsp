...
<head>
    ...
    <meta name="description" content="员工界面，记录编程/画面工作量" />
                ...
                <div class="d-flex flex-column-fluid">
                    ...
                    <div class="container">
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <!--begin::Form-->
                            <form class="form" action="${pageContext.request.contextPath}/programingPictureWorkingServlet?method=addProgramingPictureWorking" method="post">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-3">
                                            <input type="text" class="form-control" name="workname" id="workname" />
                                        ...
                                        <div class="col-9 col-form-label">
                                            <div class="radio-inline">
                                                <label class="radio radio-success">
                                                    <input type="radio" name="programingPicture" id="programingPicture1" value="编程" checked="checked"/>
                                                    <span></span>编程</label>
                                                <label class="radio radio-success">
                                                    <input type="radio" name="programingPicture" id="programingPicture2" value="画面" />
                                                    <span></span>画面</label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-3">
                                            <input type="number" class="form-control" placeholder="总开关量" name="digitalNumber" id="digitalNumber" autocomplete="off"/>
                                        </div>
                                        <label class="col-lg-2 col-form-label text-lg-right">总模拟量</label>
                                        <div class="col-lg-3">
                                            <input type="number" class="form-control" placeholder="总模拟量" name="analogNumber" id="analogNumber" autocomplete="off"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-3">
                                            <input type="number" class="form-control" placeholder="工日" name="programingDay" id="programingDay" autocomplete="off"/>
                                        </div>
                                        <label class="col-lg-2 col-form-label text-lg-right">完成情况</label>
                                        <div class="col-lg-3">
                                            <input type="number" class="form-control" placeholder="工日" name="monthday" id="monthday" autocomplete="off"/>
                                        </div>
                                    </div>
