...
<head>
    ...
    <meta name="description" content="员工界面，变更人员借调记录" />
                    ...
                    <div class="container col-lg-6 col-sm-12">
                        <div class="card card-custom gutter-b example example-compact">
                            <div class="card-header">
                                <h3 class="card-title text-primary">借调</h3>
                            </div>
                            <!--begin::Form-->
                            <form class="form" method="post" action="${pageContext.request.contextPath}/jiediaoServlet?method=addJiediao">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group col-lg-10 col-sm-12">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">借调至</span>
                                            </div>
                                            <input type="text" name="transfer" id="transfer" class="form-control" placeholder="部门/地点"/>
                                        </div>
                                        <span class="form-text text-danger col-lg-10 col-sm-12">注：此处请填写被借调至的相应地点或者部门名称。</span>
                                    </div>
                                </div>
                                <div class="card-footer">
                                    <div class="col-lg-2"></div>
                                    <div class="col-lg-10">
                                        <button type="submit" class="btn btn-primary mr-2" name="submit">提交</button>
