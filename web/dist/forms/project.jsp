...
<head>
    ...
    <meta name="description" content="员工界面，记录科室项目" />
...
<%--    <link href="<%=basePath%>dist/assets/js/bootstrap-datepicker/bootstrap-datepicker.min.css" rel="stylesheet" type="text/css" />--%>
            ...
            <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                ...
                <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
                    ...
                    <ul class="menu-nav">
                        ...
                        <li class="menu-item menu-item-active" aria-haspopup="true" ${user.power==2?"":"hidden"}>
                ...
                <div class="d-flex flex-column-fluid">
                    ...
                    <div class="container">
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <!--begin::Form-->
                            <form class="form" action="${pageContext.request.contextPath}/addProjectServlet?method=addProject" method="post">
                                <div class="card-body">
                                    ...
                                    <div class="form-group mb-8">
                                        <div class="alert alert-custom alert-default" role="alert">
                                            ...
                                            <div class="alert-text">填写时请注意，不得使用英文标点符号。如需修改可前往项目查询页面选择要修改的内容。</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-3">
                                            <input type="text" class="form-control" placeholder="项目名称" id="projectName" name="projectName" />
                                        </div>

                                        <label class="col-lg-2 col-form-label text-lg-right">工程号</label>
                                        <div class="col-lg-3">
                                            <input type="text" class="form-control" placeholder="工程号" id="projectNo" name="projectNo" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-3">
                                            <input type="text" class="form-control" placeholder="总师" id="ce" name="ce" autocomplete="off"/>
                                        </div>
                                    </div>
...
<%--<script src="<%=basePath%>dist/assets/js/bootstrap-datepicker/bootstrap-datepicker.min.js"></script>--%>
