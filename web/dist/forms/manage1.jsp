...
<head>
    ...
    <meta name="description" content="员工界面，修改经营管理工作量" />
                    ...
                    <div class="container">
                        <div class="card card-custom gutter-b example example-compact">
                            <div class="card-header">
                                <h3 class="card-title text-primary">经营管理</h3>
                            </div>
                            <!--begin::Form-->
                            <form class="form" action="${pageContext.request.contextPath}/manageWorkingServlet?method=updateManageWorking" method="post">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-3">
                                            <input type="text" class="form-control" id="projectNo" name="projectNo" value="${requestScope.manageproject.projectNo}" readonly />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-3">
                                            <input type="text" class="form-control" id="workname" name="workname" value="${manage.workname}"/>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-lg-2 col-form-label text-lg-right">商务询价</label>
                                        <div class="col-lg-3">
                                            <input type="number" class="form-control" placeholder="询价/报价" value="${manage.xunjiabaojia}" id="xunjiabaojia" name="xunjiabaojia" autocomplete="off"/>
                                        </div>
                                        <label class="col-lg-2 col-form-label text-lg-right">标书制作</label>
                                        <div class="col-lg-3">
                                            <input type="number" class="form-control" placeholder="标书" value="${manage.tender}" id="tender" name="tender" autocomplete="off"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-lg-2 col-form-label text-lg-right">合同相关</label>
                                        <div class="col-lg-3">
                                            <input type="number" class="form-control" placeholder="制作/签署等" value="${manage.sign}" id="sign" name="sign" autocomplete="off"/>
                                        </div>
                                        <label class="col-lg-2 col-form-label text-lg-right">投标工作</label>
                                        <div class="col-lg-3">
                                            <input type="number" class="form-control" placeholder="投标" value="${manage.toubiao}" id="toubiao" name="toubiao" autocomplete="off"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-lg-2 col-form-label text-lg-right">设备采购</label>
                                        <div class="col-lg-3">
                                            <input type="number" class="form-control" placeholder="设备招标采购" value="${manage.equip}" id="equip" name="equip" autocomplete="off"/>
                                        </div>
                                        <label class="col-lg-2 col-form-label text-lg-right">设备检测</label>
                                        <div class="col-lg-3">
                                            <input type="number" class="form-control" placeholder="设备出厂检测" value="${manage.test}" id="test" name="test" autocomplete="off"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-lg-2 col-form-label text-lg-right">债务相关</label>
                                        <div class="col-lg-3">
                                            <input type="number" class="form-control" placeholder="催收欠款/尾款等" value="${manage.cuikuan}" id="cuikuan" name="cuikuan" autocomplete="off"/>
                                        </div>
                                        <label class="col-lg-2 col-form-label text-lg-right">合同管理</label>
                                        <div class="col-lg-3">
                                            <input type="number" class="form-control" placeholder="合同管理" value="${manage.contract}" id="contract" name="contract" autocomplete="off"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-lg-2 col-form-label text-lg-right">其他活动</label>
                                        <div class="col-lg-3">
                                            <input type="number" class="form-control" placeholder="其他相关业务" value="${manage.other}" id="other" name="other" autocomplete="off"/>
                                        </div>
                                        <label class="col-lg-2 col-form-label text-lg-right">项目经理</label>
                                        <div class="col-lg-3">
                                            <input type="number" class="form-control" placeholder="工日" value="${manage.PMday}" id="PMday" name="PMday" autocomplete="off"/>
                                            <span class="text-danger">注：该处不写经理人名字，请经理人将工作量折合工日写在此处。</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-1">
                                        ...
                                        <textarea class="form-control" name="remark" id="remark" rows="3">${manage.remark}</textarea>
                                    </div>
