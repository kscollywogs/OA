...
<head>
    ...
    <meta name="description" content="员工界面，修改编程/画面工作量" />
                    ...
                    <div class="container">
                        <div class="card card-custom gutter-b example example-compact">
                            <div class="card-header">
                                <h3 class="card-title text-primary">编程/画面</h3>
                            </div>
                            <!--begin::Form-->
                            <form class="form" action="${pageContext.request.contextPath}/programingPictureWorkingServlet?method=updateProgectingWorking" method="post">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-3">
                                            <input type="text" class="form-control" id="projectNo" name="projectNo" value="${requestScope.programingproject.projectNo}" readonly />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-3">
                                            <input type="text" class="form-control" id="workname" name="workname" value="${programing.workname}" />
                                    ...
                                    <div class="form-group row">
                                        <label class="col-3 col-form-label text-lg-right">具体类型</label>
                                        <div class="col-9 col-form-label">
                                            <div class="radio-inline">
                                                <label class="radio radio-success">
                                                    <input type="radio" name="programingPicture" id="programingPicture1" value="编程" ${programing.programingPicture == "编程"?"checked":""}/>
                                                    <span></span>编程</label>
                                                <label class="radio radio-success">
                                                    <input type="radio" name="programingPicture" id="programingPicture2" value="画面" ${programing.programingPicture == "画面"?"checked":""} />
                                                    <span></span>画面</label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-lg-2 col-form-label text-lg-right">总开关量</label>
                                        <div class="col-lg-3">
                                            <input type="number" class="form-control" placeholder="总开关量" value="${programing.digitalNumber}" id="digitalNumber" name="digitalNumber" autocomplete="off"/>
                                        </div>
                                        <label class="col-lg-2 col-form-label text-lg-right">总模拟量</label>
                                        <div class="col-lg-3">
                                            <input type="number" class="form-control" placeholder="总模拟量" value="${programing.analogNumber}" id="analogNumber" name="analogNumber" autocomplete="off"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-3">
                                            <input type="number" class="form-control" placeholder="工日" value="${programing.programingDay}" id="programingDay" name="programingDay" autocomplete="off"/>
                                        </div>
                                        <label class="col-lg-2 col-form-label text-lg-right">完成情况</label>
                                        <div class="col-lg-3">
                                            <input type="number" class="form-control" placeholder="工日" value="${programing.monthday}" id="monthday" name="monthday" autocomplete="off"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-1">
                                        ...
                                        <textarea class="form-control" name="remark" id="remark" rows="3">${programing.remark}</textarea>
                                    </div>
