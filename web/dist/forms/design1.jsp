...
<head>
    ...
    <meta name="description" content="员工界面，修改设计工作量内容" />
                ...
                <div class="d-flex flex-column-fluid">
                    ...
                    <div class="container">
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <!--begin::Form-->
                            <form class="form" action="${pageContext.request.contextPath}/designWorkingServlet?method=updateDesignWorking" method="post">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-3">
                                            <input type="text" class="form-control" value="${requestScope.designproject.projectNo}" id="projectNo" name="projectNo" readonly />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-3">
                                            <input type="number" class="form-control" placeholder="图纸数" value="${design.amount}" id="amount" name="amount" autocomplete="off"/>
                                        </div>
                                        <label class="col-lg-2 col-form-label text-lg-right">折合成A1</label>
                                        <div class="col-lg-3">
                                            <input type="number" class="form-control" placeholder="A1 数" value="${design.a1}" id="A1" name="A1" autocomplete="off"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-3">
                                            <input type="number" class="form-control" placeholder="总工日" value="${design.zheheWorkingDay}" id="zheheWorkingDay" name="zheheWorkingDay" autocomplete="off"/>
                                        </div>
                                        <label class="col-lg-2 col-form-label text-lg-right">本月已完成</label>
                                        <div class="col-lg-3">
                                            <input type="number" class="form-control" placeholder="本月已完成" value="${design.monthDay}" id="monthDay" name="monthDay" autocomplete="off"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-3">
                                            <input type="number" class="form-control" placeholder="技术方案" value="${design.programDay}" id="programDay" name="programDay" autocomplete="off"/>
                                        </div>
                                        <label class="col-lg-2 col-form-label text-lg-right">基本设计</label>
                                        <div class="col-lg-3">
                                            <input type="number" class="form-control" placeholder="基本设计" value="${design.basicDesignDay}" id="basicDesignDay" name="basicDesignDay" autocomplete="off"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-3">
                                            <input type="number" class="form-control" placeholder="专业负责人" value="${design.leader}" id="leader" name="leader" autocomplete="off"/>
                                    ...
                                    <div class="form-group mb-1">
                                        ...
                                        <textarea class="form-control" name="remark" id="remark" rows="3">${design.remark}</textarea>
                                    </div>
