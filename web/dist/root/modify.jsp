...
<head>
    ...
    <meta name="description" content="管理员界面，修改用户信息" />
                    ...
                    <div class="container">
                        <div class="card card-custom gutter-b example example-compact">
                            <div class="card-header">
                                <h3 class="card-title text-primary">管理/修改用户</h3>
                            </div>
                            <!--begin::Form-->
                            <form method="post" action="${pageContext.request.contextPath}/manageUserServlet?method=updateUser">
                                <div class="card-body">
                                    <div class="form-group mb-8">
                                        <div class="alert alert-custom alert-default" role="alert">
                                            ...
                                            <div class="alert-text">选择指定的人员进行修改</div>
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label class="col-form-label text-right col-lg-2 col-sm-12">选择用户</label>
                                        <div class="col-lg-4 col-md-9 col-sm-12">
                                            <select class="select2w form-control" id="username" name="username">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4 col-md-9 col-sm-12">
                                            <input type="text" class="form-control" name="username1" id="username1" placeholder="用户名"  required="true" autocomplete="off">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-form-label text-right col-lg-3 col-sm-12">借调</label>
                                        <div class="col-lg-9 col-md-9 col-sm-12">
                                            <input data-value="1" data-switch="true" type="checkbox" checked="checked" data-on-text="是" data-handle-width="50" data-off-text="否" data-on-color="success" />
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label class="col-form-label text-right col-lg-3 col-sm-12">在职</label>
                                        <div class="col-lg-9 col-md-9 col-sm-12">
                                            <input data-value="1" data-switch="true" type="checkbox" checked="checked" data-on-text="是" data-handle-width="50" data-off-text="否" data-on-color="success" />
                                        </div>
                                    </div>
