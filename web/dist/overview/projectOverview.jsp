...
<head>
    ...
    <meta name="description" content="主任界面，科室全部项目查询统计" />
                    ...
                    if (data.length > 0) {
                        for (var i = 0; i < data.length; i++) {
                            content += " <tr>" +
                                ...
                                "<td class='d-none d-lg-table-cell d-xl-table-cell'>" + data[i].projectNo + "</td>" +
                                ...
                                "<td>" + data[i].ce + "</td>" +
                                "<td>" + data[i].stage + "</td>" +
                                "<td class='d-none d-lg-table-cell d-xl-table-cell'>" + data[i].remarks + "</td>" +
                                "<td>" +
                                "<div class='btn-group btn-group-sm' role='group' aria-label='button group'>" +
                                "<a title='修改信息' class='btn btn-light-success btn-icon' href='${pageContext.request.contextPath}/projectServlet?method=getProjectInfo&projectid=" + data[i].id + "'><i class='flaticon2-pen'></i></a>" +
                                "<a title='添加人员' class='btn btn-light-primary btn-icon' href='${pageContext.request.contextPath}/projectServlet?method=projectPeopleInfo&projectid="+data[i].id+"'><i class='flaticon2-add-1'></i></a>" +
                            "</div></td></tr>";
                        }
                    } else {
                        content = " <tr> <td></td><td></td><td></td><td>空</td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td> </tr>";
                    }
                    $("#tb").html(content);
                }, "json");
            }
            ...
            <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                ...
                <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
                    ...
                    <ul class="menu-nav">
                        ...
                        <li class="menu-item menu-item-active" aria-haspopup="true" ${user.power==1||user.power==2?"":"hidden"}>
                    ...
                    <div class="container container-fluid">
                        ...
                        <div class="card card-custom">
                            ...
                            <div class="card-body">
                                ...
                                <!--begin: Datatable-->
                                <table class="table table-responsive-sm table-responsive-md table-separate table-hover table-head-custom table-checkable" id="table01">
                                    <thead>
                                    <tr>
                                        <th style="width: 5%">项目<br>名称</th>
                                        <th style="width: 5%" class="d-none d-lg-table-cell d-xl-table-cell">工程号</th>
                                        <th>截止<br>日期</th>
                                        <th>完成<br>日期</th>
                                        <th>状态</th>
                                        <th>专业<br>负责人</th>
                                        ...
                                        <th>总师</th>
                                        <th>高阶段<br>分类</th>
                                        <th style="width: 10%" class="d-none d-lg-table-cell d-xl-table-cell">备注</th>
                                        <th>操作</th>
                                    </tr>
                                    </thead>
                                    <tbody id="tb">
                                    <c:if test="${!empty projectList}">
                                        <c:forEach var="project" items="${projectList}">
                                            <tr>
                                                ...
                                                <td class="d-none d-lg-table-cell d-xl-table-cell">${project.projectNo}</td>
                                                ...
                                                <td>${project.ce}</td>
                                                <td>${project.stage}</td>
                                                <td class="d-none d-lg-table-cell d-xl-table-cell">${project.remarks}</td>
                                                <td>
                                                    <div class="btn-group btn-group-sm" role="group" aria-label="button group">
                                                        <a title="修改信息" class="btn btn-light-success btn-icon" href="${pageContext.request.contextPath}/projectServlet?method=getProjectInfo&projectid=${project.id}"><i class="flaticon2-pen"></i></a>
                                                        <a title="添加人员" class="btn btn-light-primary btn-icon" href="${pageContext.request.contextPath}/projectServlet?method=projectPeopleInfo&projectid=${project.id}"><i class="flaticon2-add-1"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                        </c:forEach>
...
<style type="text/css">
    ...
    /*@media (max-width: 1024px){.mobile{display: none !important;}}*/
</style>
</body>
<!--end::Body-->
</html>