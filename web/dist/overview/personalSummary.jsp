...
<head>
    ...
    <meta name="description" content="员工界面，个人每月工作量查询统计" />
                ...
                if(data.designVoList.length>0){
                    for(var i=0;i<data.designVoList.length;i++) {
                        designContent += " <tr>" +
                            ...
                            "<td>" + data.designVoList[i].remark + "</td>" +
                            "<td>" +
                            "<div class='btn-group btn-group-sm' role='group' aria-label='button group'>" +
                            "<a title='修改' class='btn btn-light-success btn-icon' href='${pageContext.request.contextPath}/designWorkingServlet?method=getDesignInfo&designid="+data.designVoList[i].id+"'><i class='flaticon2-edit'></i></a>" +
                            "<button title='删除' type='button' class='btn btn-light-danger btn-icon' onclick=\"deDesign('"+data.designVoList[i].id+"')\"><i class='flaticon2-trash'></i></button>" +
                            "</div>" +
                            "</td>" +
                            "</tr>";
                    }
                }else{
                    designContent = " <tr> <td></td><td></td><td></td><td></td><td></td><td>空</td><td></td><td></td><td></td><td></td><td></td> </tr>";
                }
                if(data.programingVoList.length>0){
                    for(var i=0;i<data.programingVoList.length;i++) {
                        programingContent += " <tr>" +
                            ...
                            "<td>" + data.programingVoList[i].remark + "</td>" +
                            "<td>" +
                            "<div class='btn-group btn-group-sm' role='group' aria-label='button group'><a title='修改' class='btn btn-light-success btn-icon' href='${pageContext.request.contextPath}/${pageContext.request.contextPath}/programingPictureWorkingServlet?method=getProgramingInfo&programingid="+data.programingVoList[i].id+"'><i class='flaticon2-edit'></i></a>" +
                            "<button title='删除' type=\"button\" class='btn btn-light-danger btn-icon' onclick=\"dePrograming('"+data.programingVoList[i].id+"')\"><i class='flaticon2-trash'></i></button>" +
                            "</div>" +
                            "</td></tr>";
                    }
                }else{
                    programingContent = " <tr> <td></td><td></td><td></td><td></td><td>空</td><td></td><td></td><td></td><td></td><td></td> </tr>";
                }
                if(data.debugVoList.length>0){
                    for(var i=0;i<data.debugVoList.length;i++) {
                        debugContent += " <tr>" +
                            ...
                            "<td>" + data.debugVoList[i].remark + "</td>" +
                            "<td>" +
                            "<div class='btn-group btn-group-sm' role='group' aria-label='button group'><a title='修改' class='btn btn-light-success btn-icon' href='${pageContext.request.contextPath}/debugWorkingServlet?method=getProgramingInfo&debugid="+data.debugVoList[i].id+"'><i class='flaticon2-edit'></i></a>" +
                            "<button title='删除' type='button' class='btn btn-light-danger btn-icon' onclick=\"deDebug('"+data.debugVoList[i].id+"')\"><i class='flaticon2-trash'></i></button></div>" +
                            "</td></tr>";
                    }
                }else{
                    debugContent = " <tr> <td></td><td></td><td></td><td>空</td><td></td><td></td><td></td><td></td> </tr>";
                }
                if(data.manageVoList.length>0){
                    for(var i=0;i<data.manageVoList.length;i++) {
                        manageContent += " <tr>" +
                            "<td>" + i + "</td>" +
                            "<td>" + data.manageVoList[i].projectName + "</td>" +
                            ...
                            "<td>" + data.manageVoList[i].remark + "</td>" +
                            "<td>" +
                            "<div class='btn-group btn-group-sm' role='group' aria-label='button group'><a title='修改' class='btn btn-light-success btn-icon' href='${pageContext.request.contextPath}/manageWorkingServlet?method=getManageInfo&manageid="+data.manageVoList[i].id+"'><i class='flaticon2-edit'></i></a>" +
                            "<button title='删除' type='button' class='btn btn-light-danger btn-icon' onclick=\"deManage('"+data.manageVoList[i].id+"')\"><i class='flaticon2-trash'></i></button></div>" +
                            "</td></tr>";
                    }
                }else{
                    manageContent = " <tr> <td></td><td></td><td></td><td></td><td></td><td></td><td>空</td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td> </tr>";
                }
                if(data.dailyVoList.length>0){
                    for(var i=0;i<data.dailyVoList.length;i++) {
                        dailyContent += " <tr>" +
                            ...
                            "<td>" + data.dailyVoList[i].remark + "</td>" +
                            "<td>" +
                            "<div class='btn-group btn-group-sm' role='group' aria-label='button group'><a title='修改' class='btn btn-light-success btn-icon' href='${pageContext.request.contextPath}/dailyWorkingServlet?method=getDailyWorkingInfo&dailyid="+data.dailyVoList[i].id+"'><i class='flaticon2-edit'></i></a>" +
                            "<button title='删除' type='button' class='btn btn-light-danger btn-icon' onclick=\"deDaily('"+data.dailyVoList[i].id+"')\"><i class='flaticon2-trash'></i></button></div>" +
                            "</td></tr>";
                    }
                }else{
                    dailyContent = " <tr> <td></td><td></td><td>空</td><td></td><td></td> </tr>";
                }
                $("#tbSummary").html(summaryContent);
                $("#tbDesign").html(designContent);
                $("#tbPrograming").html(programingContent);
                    ...
                    <div class="container">
                        <div class="card card-custom gutter-b example example-compact">
                            <div class="card-header">
                                <h3 class="card-title text-primary">个人工作量记录</h3>
                            </div>
                                    ...
                                    <div class="alert alert-custom alert-default" role="alert">
                                        ...
                                        <div class="alert-text">
                                            <div class="d-flex justify-content-start">
                                                <div class="mr-4">
                                                    <button class="btn btn-light-success btn-icon">
                                        ...
                                        <div class="tab-content mt-5" id="myTabContent3">
                                                    ...
                                                    <c:if test="${!empty mainVo.designVoList}">
                                                        <c:forEach var="design" items="${mainVo.designVoList}" varStatus="s">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="btn-group btn-group-sm" role="group" aria-label="button group">
                                                                        <a title="修改" class="btn btn-light-success btn-icon" href="${pageContext.request.contextPath}/designWorkingServlet?method=getDesignInfo&designid=${design.id}"><i class="flaticon2-edit"></i></a>
                                                                        <button title="删除" type="button" class="btn btn-light-danger btn-icon" onclick="deDesign('${design.id}')"><i class="flaticon2-trash"></i></button>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </c:forEach>
                                            ...
                                            <div class="tab-pane fade" id="programming" role="tabpanel" aria-labelledby="tab-programming">
                                                <table class="table table-hover table-responsive-sm mt-2">
                                                    ...
                                                    <tbody id="tbPrograming" class="text-secondary">
                                                    <c:if test="${!empty mainVo.programingVoList}">
                                                        <c:forEach var="programing" items="${mainVo.programingVoList}" varStatus="s">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="btn-group btn-group-sm" role="group" aria-label="button group">
                                                                        <a title="修改" class="btn btn-light-success btn-icon" href="${pageContext.request.contextPath}/programingPictureWorkingServlet?method=getProgramingInfo&programingid=${programing.id}"><i class="flaticon2-edit"></i></a>
                                                                        <button title="删除" type="button" class="btn btn-light-danger btn-icon" onclick="deDesign('${programing.id}')"><i class="flaticon2-trash"></i></button>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </c:forEach>
                                                    ...
                                                    <c:if test="${!empty mainVo.debugVoList}">
                                                        <c:forEach var="debug" items="${mainVo.debugVoList}" varStatus="s">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="btn-group btn-group-sm" role="group" aria-label="button group">
                                                                        <a title="修改" class="btn btn-light-success btn-icon" href="${pageContext.request.contextPath}/debugWorkingServlet?method=getProgramingInfo&debugid=${debug.id}"><i class="flaticon2-edit"></i></a>
                                                                        <button title="删除" type="button" class="btn btn-light-danger btn-icon" onclick="deDesign('${debug.id}')"><i class="flaticon2-trash"></i></button>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </c:forEach>
                                            ...
                                            <div class="tab-pane fade" id="manage" role="tabpanel" aria-labelledby="tab-manage">
                                                <table class="table table-hover table-responsive-sm mt-2">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th scope="col">工程</th>
                                                        <th scope="col">工作名称</th>
                                                        <th scope="col">商务询价</th>
                                                        <th scope="col">标书制作</th>
                                                        <th scope="col">合同签署</th>
                                                        <th scope="col">投标</th>
                                                        <th scope="col">设备采购</th>
                                                        <th scope="col">设备检测</th>
                                                        <th scope="col">债务</th>
                                                    ...
                                                    <c:if test="${!empty mainVo.manageVoList}">
                                                        <c:forEach var="manage" items="${mainVo.manageVoList}" varStatus="s">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="btn-group btn-group-sm" role="group" aria-label="button group">
                                                                        <a title="修改" class="btn btn-light-success btn-icon" href="${pageContext.request.contextPath}/manageWorkingServlet?method=getManageInfo&manageid=${manage.id}"><i class="flaticon2-edit"></i></a>
                                                                        <button title="删除" type="button" class="btn btn-light-danger btn-icon" onclick="deDesign('${manage.id}')"><i class="flaticon2-trash"></i></button>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </c:forEach>
                                            ...
                                            <div class="tab-pane fade" id="daily" role="tabpanel" aria-labelledby="tab-daily">
                                                <table class="table table-hover table-responsive-sm mt-2">
                                                    <thead>
                                                    <tr>
                                                        <th scope="col">#</th>
                                                    ...
                                                    <c:if test="${!empty mainVo.dailyVoList}">
                                                        <c:forEach var="daily" items="${mainVo.dailyVoList}" varStatus="s">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="btn-group btn-group-sm" role="group" aria-label="button group">
                                                                        <a title="修改" class="btn btn-light-success btn-icon" href="${pageContext.request.contextPath}/dailyWorkingServlet?method=getDailyWorkingInfo&dailyid=${daily.id}"><i class="flaticon2-edit"></i></a>
                                                                        <button title="删除" type="button" class="btn btn-light-danger btn-icon" onclick="deDesign('${daily.id}')"><i class="flaticon2-trash"></i></button>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </c:forEach>
