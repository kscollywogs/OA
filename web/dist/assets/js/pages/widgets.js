...
var KTWidgets = function () {
    ...
    var _initDaterangepicker = function () {
        ...
        //     ranges: {
        //         '今日': [moment(), moment()],
        //         '昨日': [moment().subtract(1, '日'), moment().subtract(1, '日')],
        //         '前 7 日': [moment().subtract(6, '日'), moment()],
        //         '前 30 日': [moment().subtract(29, '日'), moment()],
        //         '本月': [moment().startOf('月'), moment().endOf('月')],
        //         '上月': [moment().subtract(1, '月').startOf('月'), moment().subtract(1, '月').endOf('月')]
        //     }
        // }, cb);
