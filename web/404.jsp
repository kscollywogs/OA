...
<head>
    ...
    <meta name="description" content="错误(code: 404)" />
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no" />
    <!--begin::Fonts-->
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700" />
    <!--end::Fonts-->
    <!--begin::Page Custom Styles(used by this page)-->
    <link href="<%=basePath%>dist/assets/css/pages/error/error-3.css" rel="stylesheet" type="text/css" />
...
<div class="d-flex flex-column flex-root">
    <!--begin::Error-->
    <div class="error error-3 d-flex flex-row-fluid bgi-size-cover bgi-position-center" style="background-image: url(<%=basePath%>dist/assets/media/error/bg3.jpg);">
        <!--begin::Content-->
        <div class="px-10 px-md-30 py-10 py-md-0 d-flex flex-column justify-content-md-center">
            ...
            <p class="font-size-h1 font-weight-boldest text-dark-75">您所找的页面似乎跑丢了</p>
            <p class="font-size-h4 line-height-md">看起来您所输入的路径地址有误，或者您所访问的地址已不存在。</p>
